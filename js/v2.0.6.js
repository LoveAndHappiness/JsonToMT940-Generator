...
:28C:`;
        ...
        createTransactionDescriptionLines(description) {

          // Sanitize the description to only include allowed characters
          ...
          // Truncate the description to a maximum of 65 characters
          // const truncatedDescription = cleanedDescription.substring(0, 65);
          // const formattedDescription = `:86:${truncatedDescription}`;
          // return formattedDescription;

          // Split lines that are longer than 65 characters
          const formattedDescription = `:86:${cleanedDescription}`;
        ...
        generateTransactionLines(formattedDate, transaction, transactionAmount) {
          ...
          const transactionDescriptionLines = this.createTransactionDescriptionLines(transaction.Verwendungszweck);
